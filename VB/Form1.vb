...
Namespace ChartStackedSorting
    ...
    Public Class TotalScaleValuesComparer
        ...
        Private Function GetTotalByArg(ByVal arg As Object) As Double
            Return chart.Series.SelectMany(Function(s) s.ActualPoints).Where(Function(p) Object.Equals(p.ArgumentX.QualitativeArgument, arg)).Sum(Function(p) p.UserValues(0))
        End Function
    End Class
